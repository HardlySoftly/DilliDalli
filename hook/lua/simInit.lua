local DilliDalliBeginSession = import('/mods/DilliDalli/lua/GammaAI/framework/mapping/Mapping.lua').BeginSession
local DilliDalliLoadProductionGraph = import('/mods/DilliDalli/lua/GammaAI/framework/production/ProductionGraph.lua').LoadProductionGraph
...
local DilliDalliCreateMarker = import('/mods/DilliDalli/lua/GammaAI/framework/mapping/Mapping.lua').CreateMarker
...
local DilliDalliSetPlayableArea = import('/mods/DilliDalli/lua/GammaAI/framework/mapping/Mapping.lua').SetPlayableArea
