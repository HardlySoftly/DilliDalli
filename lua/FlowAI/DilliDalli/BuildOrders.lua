...
LandLand = {
    ...
    factory = {
        { work="EngineerT1", priority=4, location=nil, distance=0, targetSpend=20, buildOrder=true, count=2, duplicates=1, keep=false, assist=false },
        { work="DirectFireT1", priority=3, location=nil, distance=0, targetSpend=20, buildOrder=true, count=2, duplicates=1, keep=false, assist=false },
        { work="LandScoutT1", priority=2, location=nil, distance=0, targetSpend=20, buildOrder=true, count=2, duplicates=1, keep=false, assist=false },
        { work="EngineerT1", priority=1, location=nil, distance=0, targetSpend=20, buildOrder=true, count=1, duplicates=1, keep=false, assist=false },
    }
}